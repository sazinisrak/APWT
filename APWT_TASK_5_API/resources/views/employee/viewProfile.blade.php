                ...
                <div class="card">
                    <div class="position-relative">
                        <div
                            ...
                            <div>
                                <img class="wd-70 rounded-circle" src="{{ $employee['picture'] }}" alt="profile">
                                <span class="h4 ms-3 text-dark">{{ $employee['name'] }}</span>
                            </div>
                            <div class="d-none d-md-block">
                                <a href="{{route('employeeEditProfile')}}" class="btn btn-primary btn-icon-text">
